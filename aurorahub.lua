if getgenv().cuppink then warn("Aurora Hub : Already executed!") return end
...
local Window = Fluent:CreateWindow({
    Title = game:GetService("MarketplaceService"):GetProductInfo(16732694052).Name .." | Aurora Hub - Premium",
    SubTitle = "discord.gg/aurorahub)",
    TabWidth = 160,
